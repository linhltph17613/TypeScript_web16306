    ...
    <div className="">
      ...
      <div className="bg-amber-50 py-4">
        <div className=" flex justify-between items-center max-w-5xl mx-auto">
          <div className="">
            <a className="font-medium hover:text-[#b97c5e] " href="/">
              Home
            </a>

            <a
              className="font-medium text-[#b97c5e] hover:text-[#b96c4e]"
              href="/shop"
            >
              {" "}
              Shop
        ...
        <div className="bg-gray-100 pl-5 left-0  ml-4 py-9 w-1/3">
          ...
          <div className="">
            ...
            <ul className="">
              <li>
                <a
                  className="py-2 text-[#b97c5e] hover:text-[#b96c4e] font-medium"
                  href=""
                >
                  Clay
                </a>
